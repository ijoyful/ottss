...
<style type="text/css">
	...
	#main .listInner ul li:nth-child(1) {width: 5%;} /* checkbox */
	#main .listInner ul li:nth-child(2) {width: 5%;} /* no */
	#main .listInner ul li:nth-child(3) {width: 5%;} /* 구분 */
	#main .listInner ul li:nth-child(4) {width: 50%;} /* 제목 */
	#main .listInner ul li:nth-child(5) {width: 10%;} /* 작성자 */
	#main .listInner ul li:nth-child(6) {width: 20%;} /* 작성일 */
	#main .listInner ul li:nth-child(7) {width: 5%;} /* 조회수 */
</style>
<script type="text/javascript">
	function changeList() {
		const f = document.listForm;
		f.page.value = '1';
		f.action = '${pageContext.request.contextPath}/admin/freeboard/list';
		f.submit();
	}
	...
	$(function(){
		...
		$('#btnDeleteList').click(function(){
			...
			if(confirm('선택한 게시글을 삭제 하시겠습니까 ? ')) {
				const f = document.listForm;
				f.action = '${pageContext.request.contextPath}/admin/freeboard/deleteList';
				f.submit();
			}
		});
				...
				<div class="mainInner">
						...
						<div class="listInner">
							...
							<c:forEach var = "dto" items="${list}" varStatus="status">
								<ul class="listContent">
									<li>
										<input type="checkbox" class="form-check-input" name="nums" value="${dto.fb_num}">
									</li>
					...
					<div class="row board-list-footer">
						<div class="col p-1 text-start">
							<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/freeboard/list';"><i class="bi bi-arrow-clockwise"></i></button>
						</div>
						<div class="col-6 text-center">
							<form class="row" name="searchForm" action="${pageContext.request.contextPath}/admin/freeboard/list" method="post" style="justify-content: center;">
						...
						<div class ="col text-end">
							<button type="button" style="align-content: right" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/freeboard/write';">글올리기</button>
						</div>
					</div>
				</div>
			</div>

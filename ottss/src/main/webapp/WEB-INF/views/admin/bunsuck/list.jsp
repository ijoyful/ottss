...
<script type="text/javascript">
	function changeList() {
		...
		f.page.value = '1';
		f.action = '${pageContext.request.contextPath}/admin/bunsuck/list';
		f.submit();
	}
	...
	$(function(){
		...
		$('#btnDeleteList').click(function(){
			...
			if(confirm('선택한 게시글을 삭제 하시겠습니까 ? ')) {
				const f = document.listForm;
				f.action = '${pageContext.request.contextPath}/admin/bunsuck/deleteList';
				f.submit();
			}
		});
          	...
          	<div class="body-main">
				<div class="mainInner">
					...
					<div class="row board-list-footer">
						<div class="col">
							<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/bunsuck/list';"><i class="bi bi-arrow-clockwise"></i></button>
						</div>
						<div class="col-6 text-center">
							<form class="row" name="searchForm" action="${pageContext.request.contextPath}/admin/bunsuck/list" method="post" style="justify-content: center;">
						...
						<div class="col text-end">
							<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/bunsuck/write';">글올리기</button>
						</div>
					</div>				
				</div><!-- mainInner -->
			</div>

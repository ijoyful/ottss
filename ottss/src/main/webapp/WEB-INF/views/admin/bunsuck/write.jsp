...
function sendOk() {
    ...
    f.action = '${pageContext.request.contextPath}/admin/bunsuck/${mode}';
    f.submit();
}
</script>
								...
								<table class="table table-borderless">
				 					<tr>
										<td class="text-center">
											...
											<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/bunsuck/list?size=${size}';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button>
